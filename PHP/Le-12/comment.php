...
<table width=98% align=center border=0 cellpadding=5 cellspacing=0>
  ...
  <tr>
    <td valign=top colspan=2 id="comment_<?=$row_cmt[id]?>"><?=$comment?></td>
  </tr>
</table>
<? } ?>
...
<script type="text/javascript">
  function change_form(id) {
    ...
    document.comment_insert.comment.cols   = 61;
    document.comment_insert.register.value = "수정";

    var str = "<input type=button value=' 취소 '";
    str += "style='height:80;width:57' onclick='restore_form()'>";

    document.getElementById("cancel").innerHTML = str;
