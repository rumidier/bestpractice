        ...
        case 2:
            {
              ...
              spec_rut = malloc (sizeof (struct linked_list));
              spec_rut -> next_ptr = first_ptr;

              if (spec_value == 1)
                {
                  spec_don_check = list_spec_check (first_ptr, spec_id, spec_rut -> next_ptr);
              ...
              else if (spec_value == 0)
                {
                  ...
                  if (!spec_don_check)
                    ...
                    {
                      list_spec_delete (first_ptr, spec_id, spec_rut -> next_ptr);
                    }
                }
              else
                {
        ...
        case 6:
            {
              ...
              rut = malloc (sizeof (struct linked_list));
              rut -> next_ptr = first_ptr;
